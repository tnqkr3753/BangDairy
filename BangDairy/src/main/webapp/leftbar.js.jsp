...
<script type="text/javascript" src="resources/js/js1/j.jquery.stellar.js"></script> 
<script type="text/javascript" src="resources/js/js1/j.module.js"></script>
<script src="resources/js/js1/j.wow.min.js"></script>
<script>
		new WOW().init();
		</script>
