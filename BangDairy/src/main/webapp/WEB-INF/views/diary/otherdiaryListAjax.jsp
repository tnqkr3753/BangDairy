	...
	<table>
		<thead>
			...
			<tbody class="diaryList">
				<!-- 다이어리 리스트에서 하나씩 뽑아옴 -->
				<c:forEach items="${odiaryDetailList}" var="myDiaryList">
...
$(".btnDiaryList").click(function() {
	...
	$.ajax({
		type : 'POST',	// 요청 메소드 타입
		url : "showODiaryList/" + pNum,	// 클라이언트가 HTTP 요청을 보낼 서버의 주소
