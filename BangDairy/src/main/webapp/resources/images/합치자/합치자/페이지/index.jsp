	    ...
	    <div class="col-full">
	        ...
	        <div class="featured">
	            ...
	            <div class="featured__column featured__column--big">
	                <div class="entry" style="background-image:url('resources/images/thumbs/featured/featured-guitarman.jpg');">
	            ...
	            <div class="featured__column featured__column--small">
	                ...
	                <div class="entry" style="background-image:url('resources/images/thumbs/featured/featured-watch.jpg');">
                    ...
                    <div class="entry__text">
                        ...
                        <div class="entry__meta">
                            <span class="entry__meta-links">
                                 <a href="#0"><i class="fa fa-play-circle-o" aria-hidden="true"title="예고편시청"></i></a>
                                <a href="#0"><i class="fa fa-heart" aria-hidden="true"title="좋아요"></i></a>
                            </span>
                        </div>
                         </div>
                         </li>
             ...
             <article class="masonry__brick entry format-standard" data-aos="fade-up">
                    ...
                    <div class="entry__thumb">
                        ...
                        <a href="single-standard.html" class="entry__thumb-link" >
                            <img src="resources/images/아이유.jpg" class="entry__thumb-link1"
                                    srcset="resources/images/아이유 .jpg 2x, resources/images/thumbs/masonry/lamp-800.jpg 2x" alt="">
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <h1 class="entry__title"><a href="single-standard.html"> <%="2번넣기" %></a></h1>
             ...
             <article class="masonry__brick entry format-standard" data-aos="fade-up">
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <h1 class="entry__title"><a href="single-standard.html">가수,연기자</a></h1>
