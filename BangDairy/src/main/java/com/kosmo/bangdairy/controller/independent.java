...
import com.kosmo.bangdairy.vo.OstVO;
...
public class independent {
	...
	public String movieAppImsert(DirectorVO Dvo, GenreVO gvo, MovieVO mvo,ReviewVO rvo,OstVO ovo,HttpServletRequest request, HttpSession session ) {	
